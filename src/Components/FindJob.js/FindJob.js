...
import job_list1 from '../../assets/img/icon/job-list1.png'
import job_list2 from '../../assets/img/icon/job-list2.png'
import job_list3 from '../../assets/img/icon/job-list3.png'
import job_list4 from '../../assets/img/icon/job-list4.png'
                        ...
                        <section className="featured-job-area">
                            <div className="container">
                                ...
                                <div className="single-job-items mb-30">
                                    <div className="job-items">
                                        <div className="company-img">
                                            <Link to="#"><img src={job_list1} alt="" /></Link>
                                        </div>
                                ...
                                <div className="single-job-items mb-30">
                                    <div className="job-items">
                                        <div className="company-img">
                                            <Link to="#"><img src={job_list2} alt="" /></Link>
                                        </div>
                                        <div className="job-tittle job-tittle2">
                                            <Link to="#">
                                                <h4>Digital Marketer</h4>
                                ...
                                <div className="single-job-items mb-30">
                                    <div className="job-items">
                                        <div className="company-img">
                                            <Link to="#"><img src={job_list3} alt="" /></Link>
                                        </div>
                                        <div className="job-tittle job-tittle2">
                                            <a href="#">
                                                <h4>Digital Marketer</h4>
                                ...
                                <div className="single-job-items mb-30">
                                    <div className="job-items">
                                        <div className="company-img">
                                            <Link to="#"><img  src={job_list4} alt="" /></Link>
                                        </div>
                                        <div className="job-tittle job-tittle2">
                                            <Link to="#">
                                                <h4>Digital Marketer</h4>
                                ...
                                <div className="single-job-items mb-30">
                                    <div className="job-items">
                                        <div className="company-img">
                                            <Link href="#"><img src={job_list1} alt="" /></Link>
                                        </div>
                                        <div className="job-tittle job-tittle2">
                                            <Link to="#">
                                                <h4>Digital Marketer</h4>
