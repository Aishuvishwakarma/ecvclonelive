...
function EmployPersonalDetailBx(props) {
 ...
 { props.history.location.pathname === '/EditResume/personalinfo' ?<><br/>
             <button type="button" style={{ border: 'none',marginTop:'20px' }} data-toggle="modal" data-target="#EmployPersonalDetailBx">
             ...
             <button type="button" style={{ border: 'none' }} data-toggle="modal" data-target="#EmployPersonalDetailBx">
                <i style={{ color: '#DA2461', fontSize: '20px' }} class="fas fa-pen"></i>
            </button>
             </>}
           
            <ToastContainer />
            <div className="modal fade" id="EmployPersonalDetailBx" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(EmployPersonalDetailBx));
