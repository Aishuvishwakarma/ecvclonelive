...
function AddClgBx(props) {
    const [state, setstate] = useState({Feild:'', Graduation: '', CollegeName: '', Stream: '', CLGYR: '', Performance: '', Completion: '', State: '', City: '', From: '', To: '' })
    ...
    const onSubmitForm = (e) => {
        ...
        if (obj.Graduation && obj.Stream && obj.Feild && obj.Performance && obj.Completion && obj.State && obj.City && obj.CollegeName) {
    ...
    return (
        <>
            <button type="button" style={{ border: 'none' }} data-toggle="modal" data-target="#addClg">
                <b style={{ fontSize: '15px', color: '#DA2461', display: 'flex', alignItems: 'center', marginBottom: '5px' }}>
                    <i style={{ fontSize: '12px', marginRight: '10px' }} class='fas fa-plus-circle'></i>Add Graduation/post Graduation
                </b>
                <ToastContainer />
            </button>

          
            <div className="modal fade" id="addClg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="heading_bg">
                                        ...
                                        <p>Graduation/Post Graduation details</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="modal-body">
                                <div className='container'>
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-md-6">
                                            <p>Stream</p>
                                            <input  className={Dilogcss.DilogInput}  style={{marginBottom:'8px'}} type="text" name='Stream' onChange={onFormChange} placeholder="e.g. Your Branch/stream name" />
                                        </div>
                                        <div className="col-12 col-md-6">
                                        <p>Feild</p>
                                                        <select  className={Dilogcss.DilogInput}  style={{marginBottom:'10px'}} name='Feild' onChange={onFormChange}>
                                                    <option disabled className={Dilogcss.DilogInput} value=''>Select Feild</option>
                                                    <option  className={Dilogcss.DilogInput} value='B_tech'>B TECH</option>
                                                    <option  className={Dilogcss.DilogInput} value='B_tech'>B TECH</option>
                                                    <option  className={Dilogcss.DilogInput} value='B_tech'>B TECH</option>
                                                    <option  className={Dilogcss.DilogInput} value='B_tech'>B TECH</option>
                                                    <option  className={Dilogcss.DilogInput} value='B_tech'>B TECH</option>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(AddClgBx));
