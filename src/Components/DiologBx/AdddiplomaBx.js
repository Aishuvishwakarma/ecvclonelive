...
function AdddiplomaBx(props) {
    ...
    return (
        <>
            <button type="button" style={{ border: 'none' }} data-toggle="modal" data-target="#AdddiplomaBx">
                <b style={{ fontSize: '15px', color: '#DA2461', display: 'flex', alignItems: 'center', marginBottom: '5px' }}>
                    <i style={{ fontSize: '12px', marginRight: '10px' }} class='fas fa-plus-circle'></i>Add diploma
                </b>
                <ToastContainer />
            </button>


            <div className="modal fade" id="AdddiplomaBx" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(AdddiplomaBx));
