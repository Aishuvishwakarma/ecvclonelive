...
function EmployOrganizationBx(props) {
    const [logo, setlogo] = useState({ oldlogo: '', logo: '' });
    const [state, setstate] = useState({ Organization: '', Jobtitle: '', City: '', State: '', StartDate: '', EndDate: '',org_desc:'' })
    ...
    const onClickImage = () => {
        ...
        document.querySelector('input[type="file"]').onchange = function (e) {
           setlogo(prevavtar => ({ ...prevavtar, [e.target.name]: e.target.value }));
 ...
 { props.history.location.pathname === '/EditResume/personalinfo' ?<><br/>
             <button type="button" style={{ border: 'none',marginTop:'20px' }} data-toggle="modal" data-target="#EmployExperienceBx">
             ...
             <button type="button" style={{ border: 'none' }} data-toggle="modal" data-target="#EmployOrganizationBx">
            ...
            <div className="modal fade" id="EmployOrganizationBx" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                ...
                                <div className="container">
                                    ...
                                    <div className="row mt-3">
                                            <div className="col-12 col-md-12">
                                                <textarea value={state.org_desc}
                                                placeholder='Organization description'
                                                style={{minHeight:'100px'}}
                                                className={Dilogcss.DilogInput}
                                                 name='org_desc' onChange={onFormChange} />
                                            </div>
                                        </div>
                                        <div className="row mt-3">
                                            <div className="col-12 col-md-12">
                                            ...
                                            <input type="submit" />
                                               ...
                                               className={Dilogcss.btnprfl}>UPLOAD LOGO</button>
                                               <p style={{fontSize:'10px'}}> Max file size: 1Mb and max resolution: 500px x 500px. File type: jpeg, jpg, png, gif, bmp </p>
                                            </div>
                                            <div className="col-12 col-md-6">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(EmployOrganizationBx))
